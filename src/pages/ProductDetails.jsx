      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-x-8">
        ...
        <div className="lg:max-w-lg lg:self-end">
          <div className="aspect-w-1 aspect-h-1 rounded-lg overflow-hidden">
            <div className="w-full h-96 bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg" />
          </div>
        </div>
        ...
        <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
          ...
          <div className="mt-8">
            <button
              ...
              className="w-full bg-purple-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
            >
              Add to Cart
            </button>
          </div>
